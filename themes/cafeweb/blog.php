...
<section class="blog_page">
    ...
    <div class="content content">
        <div class="empty_content">            
            <h3 class="empty_content_title">Sua Pesquisa nao retornou resultados :/</h3>
            <p class="empty_content_desc">Voçê Pesquisou por <b><?= $search; ?></b>. Tente outros Termos</p>
    ...
    <?php elseif (empty($blog)): ?>
        ...
        <div class="empty_content">            
            ...
            <p class="empty_content_desc">Nossos editores estão preparando um conteúdo de primeira para voçê.</p>
        </div>
    </div>
    <?php else: ?>
