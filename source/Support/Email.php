...
class Email
{
     ...
     * Method bootstrap
     *
     * @param string $subject [explicite description]
     * @param string $body [explicite description]
     * @param string $recipient [explicite description]
     * @param string $recipienteName [explicite description]
     *
     * @return Email
     */
    public function bootstrap(string $subject, string $body, string $recipient, string $recipienteName): Email
    {
        $this->data->subject = $subject;
        $this->data->body = $body;
        $this->data->recipient_email = $recipient;
        $this->data->recipient_name = $recipienteName;
        return $this;
    }
